...
<body>
    <header>
        <div class="pageHeading">
            <div class="menu">
                <form>
                    <button type="button" name="menu" id="menu"><img src="../Images/NavImages/Menu_Icon.png" alt="Menu Logo"></button>
                </form>
            </div>
            <div class="logo">
        ...
        <div class="navbar">
            ...
            <a href="admindiscuss.php" class="selected">Discussion Forums</a>
        </div>
